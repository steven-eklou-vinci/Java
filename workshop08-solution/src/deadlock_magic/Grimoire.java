...
public class Grimoire {
    ...
    public enum Ceremonie {
        // Solution: on ordonne les incantations
        ...
        RITUEL_DU_CREPUSCAL_ABYSSAL(Incantation.FLAMBOIEMENT_ARDENT, Incantation.RESONNANCE_DES_SAGES, Incantation.MURMURES_GIVRES );
