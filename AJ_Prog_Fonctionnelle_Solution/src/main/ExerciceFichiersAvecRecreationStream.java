...
public class ExerciceFichiersAvecRecreationStream {
    ...
    public static void main(String[] args) {
        ...
        ExerciceFichiersAvecRecreationStream main = new ExerciceFichiersAvecRecreationStream(linesSupplier);
        main.run();
    }
    ...
    public ExerciceFichiersAvecRecreationStream(
            Supplier<Stream<String>> linesSupplier    ) {
